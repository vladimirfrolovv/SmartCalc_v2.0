...
namespace s21 {
    ...
    int Model::unar_op_and_functions(std::stack<double> &stack_value, int status, char curr_op) {
        double b = 0;
        double result = 0;
    ...
    int Model::operators(std::stack<double> &stack_value, int status, char curr_op) {
